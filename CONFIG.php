...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/2h_signos_para_todos/css/styleExtra.css">
    <link rel="icon" href="/2h_signos_para_todos/imagenes/icon2h.png" type="image/png">
    <title>2H - Usuario Admin - Config</title>
</head>
<body>
    <div class="dashboard">
        <!-- Sidebar -->
        ...
        <div class="main-content">
            <img src="/2h_signos_para_todos/imagenes/nohaysistema.jpg" alt="no-jai-ziztema">
        <div>
</body>
</html>